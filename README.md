...
```
git clone https://github.com/AndreyKhamid/DataCleaningProject.git
```
...
В результате проведенной работы по очистке данных локализованы и удалены из датасета выбросы жилья по ценовому и ряду других показателей.
